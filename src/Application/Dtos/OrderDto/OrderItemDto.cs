    ...
    public class OrderItemDto:IMapFrom<OrderItem>
    {
        ...
        public void Mapping(Profile profile)
        {
            profile.CreateMap<OrderItem, OrderItemDto>()
                ...
                .ForMember(x => x.ProductName,c => c.MapFrom(v => v.ItemOrdered.ProductName))
                .ForMember(x => x.ProductItemId,c => c.MapFrom(v => v.ItemOrdered.ProductItemId))
                ...
                .ForMember(x => x.PictureUrl,c => c.MapFrom(v => v.ItemOrdered.PictureUrl));
        }
    }
}
